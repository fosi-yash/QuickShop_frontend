                    ...
                    <div className={` container  text-center `}>
                        {cartItems.map((item, index) => (
                            <div className='p-1 shadow-sm rounded' key={index + 1}>
                                <div className=" bg-white mt-1 d-flex p-1 pt-2">
                                    ...
                                    <div className='d-flex pt-2 w-25 mt-3' style={{margin:'auto auto'}} >
                                        <button className='btn h-25 mt-5 ms-2 w-75 bg-danger' onClick={(e) => { removeClick(e, item._id) }}><i className="fa-duotone fa-solid fa-trash" ></i> Remove</button>
                                        </div>
